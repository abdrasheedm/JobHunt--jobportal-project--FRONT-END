...
function SeekerProfile() {
  ...
  const [projModalType, setProjModalType] = useState("");
  const [projModalId, setProjModalId] = useState();
  ...
  const fetchExperience = () => {
    axios
      .get(`seeker-experience/?id=${profile_id}`, {
        headers: {
          Authorization: `Bearer ${token.access}`,
        },
      })
  ...
  const fetchProjects = () => {
    axios
      .get(`seeker-project/?id=${profile_id}`, {
        headers: {
          Authorization: `Bearer ${token.access}`,
        },
      })
                    ...
                    <div className="p-5 mt-5 grid grid-cols-9 bg-gray-200 rounded-lg shadow-md shadow-blue-100">
                      ...
                      <div className="col-span-1 pt-5 flex flex-wrap">
                        <span
                          ...
                          onClick={() => {
                            setProjModalType("edit");
                            setProjModalId(project.id);
                            setProjModal(true);
                          }}
                        >
                          <i class="fa-sharp fa-solid fa-pen"></i>

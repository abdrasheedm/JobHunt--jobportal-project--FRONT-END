          ...
          <div className="col-span-4 px-10 py-5">
            ...
            {jobs.map((job, index) => {
              ...
              <div className="col-span-2">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzRCgx-jrMQUQENdxiV71ZtID09zMRz3hnew&usqp=CAU" className="rounded-lg w-20 h-20 object-cover" alt="" />
              </div>
              <div className="col-span-5 pr-5 hover:cursor-pointer" onClick={() => navigate('/seeker-single-job-view', {state: {data:job.id}})}>
                <h1 className="capitalize text-xl font-bold pt-3">{job.job_title} </h1>
               <div className="flex pt-3">
               <p className="mr-5 text-gray-600"><i class="fa-solid fa-user-tie"></i> &nbsp;{job.category?.category_name} </p>
                <p className="text-gray-600"><i class="fa-thin fa-briefcase"></i> &nbsp; {job.salary_range} </p>
               </div>
              </div>
              <div className="col-span-2 flex flex-col">
                <button className="bg-myGreen hover:bg-green-500 text-white px-7 py-2 rounded-md">Apply Now</button>
                <p className="text-center pt-3 italic text-gray-600">Last Date : {job.last_date} </p>
              </div>
            </div>
              )
            })}
